  ...
  return (
    <div ref={containerRef} style={{ position: "relative" }}>
      <button
        ...
        style={{ position: "relative", background: "none", border: "none", cursor: "pointer", padding: 6, borderRadius: 8, color: "#374151", display: "flex", alignItems: "center" }}
      >
      ...
      {open && (
        <div style={{ position: "absolute", top: "calc(100% + 8px)", right: 0, width: 300, maxHeight: 360, overflowY: "auto", background: "#fff", border: "1px solid #e2e8f0", borderRadius: 12, boxShadow: "0 12px 32px rgba(0,0,0,0.14)", zIndex: 50 }}>
          <div style={{ padding: "12px 16px", fontSize: 13, fontWeight: 700, color: "#1e293b", borderBottom: "1px solid #f1f5f9" }}>
            Notifications
          </div>
          {notifications.length === 0 ? (
            <div style={{ padding: 20, fontSize: 13, color: "#94a3b8", textAlign: "center" }}>You&apos;re all caught up!</div>
          ) : (
            notifications.map((n, i) => {
              const row = (
                <div style={{ padding: "12px 16px", borderBottom: i < notifications.length - 1 ? "1px solid #f8fafc" : "none" }}>
